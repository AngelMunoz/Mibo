...
- **MonoGame 3D:** fragments facing away from the directional light no longer sample its shadow map — their directional contribution is zero regardless, so roughly half the lit surface in a sun-lit scene skips the shadow texture reads.
