...
// The adaptive input mapping surface for the MonoGame backend. The
// runtime-neutral delta-attachment logic lives in Mibo.MonoGame (module
// InputMapperDeltas); the MVU counterparts of the subscriptions here live in
// Mibo.MonoGame.Mvu. All members keep their home in the
